...
function buildPrintAgentScript(cfg) {
  return [
    ...
    '// "-print-settings noscale,simplex": het PDF-document (Trunkrs-label of',
    '// onze eigen pakbon) staat al op het juiste formaat, dus niet laten',
    '// schalen. "simplex" erbij sinds 14-09-2026: bij een pakbon-bulkprint',
    '// (na de 25mb-fix in PR #48) staan er nu meerdere pakbonnen als aparte',
    '// pagina\'s in 1 PDF, en dan bleek de printer standaard op dubbelzijdig',
    '// te staan - met 1 pakbon per printopdracht (de situatie hiervoor) viel',
    '// dat nooit op, want dan bleef de achterkant van dat ene vel gewoon leeg.',
    '// Forceert hier per printopdracht enkelzijdig, ongeacht de standaard-',
    '// instelling van de Windows-printerdriver - raakt dus niet de driver zelf.',
    ...
    '        if (err) { reject(err); return; }',
    '        execFile(sumatraPath, ["-print-to", printerNaam, "-silent", "-exit-when-done", "-print-settings", "noscale,simplex", tmpFile], { timeout: 30000 }, function(err2) {',
